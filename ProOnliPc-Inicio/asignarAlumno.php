...
<body>
  ...
  <section id="hero">
    <div class="hero-container">
      <div class="wow fadeIn">
      	 <h1>Administrador</h1>
        <div class="actions">
          <a href="#RegistroAlumnos" class="btn-services">Asignar Servicio a Alumno</a>
  ...
  ============================-->
   <section id="RegistroAlumnos">
    ...
    <div class="container wow fadeInUp">
      <div class="row">
        <div class="col-md-12">
          <h3 class="section-title">Asignar Servicio a Alumno</h3>
          <div class="section-title-divider"></div>
          <h4 class="section-title">Datos del Alumno</h4>
  ...
  <div class="section-title-divider"></div>
  <h4 class="section-title">Datos del Servicio</h4>
      <div class="form-group col-md-6">
        <label for="inputTelefono">Seleccione opcion de servicio social</label>
        <br>
        <select name="NombreSolicitante">
              <?php 
